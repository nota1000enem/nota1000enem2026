...
export const Route = createFileRoute("/perfil")({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Meu Perfil – Nota 1000 ENEM" },
      { property: "og:description", content: "Gerencie seu perfil, foto, dados pessoais e verificação de e-mail no Nota 1000 ENEM." },
      { property: "og:url", content: "https://nota1000enem.online/perfil" },
    ],
