...
const trilhas: Trilha[] = [
  {
    ...
    aulas: [
      ...
      { t: "📈 INTERPRETAÇÃO DE GRÁFICOS, EQUAÇÕES E FUNÇÕES: Aula Completa", min: 90 },
      { t: "TUDO DE PROBABILIDADE E ANÁLISE COMBINATÓRIA (Ensino Médio e ENEM)", min: 75 },
      { t: "TUDO DE GEOMETRIA E TRIGONOMETRIA PARA O ENEM 2024!!", min: 95 },
      { t: "TUDO de Matemática do Ensino FUNDAMENTAL pro ENEM 2026 (pra quem tem MUITA DIFICULDADE)", min: 110 },
      { t: "AULÃO ENEM: O que mais cai em FÍSICA no Enem", min: 130 },
      { t: "TUDO de QUÍMICA GERAL pro ENEM 2026 (GANHE MUITOS ACERTOS)", min: 100 },
    ],
  },
  {
    ...
    aulas: [
      ...
      { t: "11 Horas de Aula (Linguagens códigos e suas tecnologias)", min: 660 },
    ],
  },
  {
    ...
    aulas: [
      ...
      { t: "✅ MACETES de HUMANAS para o ENEM 2026 (+800 PONTOS com eles!)", min: 60 },
      { t: "Aulão de Revisão Enem: Ciências Humanas e suas Tecnologias", min: 180 },
      { t: "CORREÇÃO ENEM 2025 | LINGUAGENS, CIÊNCIAS HUMANAS E REDAÇÃO", min: 200 },
      { t: "Revisão Final ENEM (PROVA 2021) - Ciências Humanas", min: 90 },
    ],
  },
  {
    ...
    aulas: [
      ...
      { t: "💪 CORREÇÃO DO ENEM NATUREZA 2025 (45 Acertos) - Ciências da Natureza", min: 150 },
      { t: "Como GABARITAR Ciências da NATUREZA do Enem 2026 na PRÁTICA", min: 75 },
      { t: "🍀🤯 Ciências da Natureza e suas Tecnologias para o ENEM 2026: Revisão Completa 3 ANOS EM 4 HORAS!!", min: 240 },
    ],
  },
  {
    ...
    aulas: [
      ...
      { t: "AULÃO ENEM DE LITERATURA E REDAÇÃO: OS TEMAS QUE MAIS CAEM | AULÃO ENEM 2025", min: 180 },
      { t: "NOVO MODELO REDAÇÃO ENEM 2026 (+900 em QUALQUER TEMA)", min: 30 },
      { t: "COMO FAZER UMA REDAÇÃO NOTA MÁXIMA? ENEM 2026", min: 28 },
    ],
  },
  {
    ...
    aulas: [
      ...
      { t: "🔴 [ENEM 2025] GABARITO EXTRAOFICIAL Matemática", min: 180 },
      { t: "🍀 CORREÇÃO COMPLETA BIOLOGIA #Enem 2021: Questões resolvidas PASSO A PASSO", min: 100 },
      { t: "🚗 TUDO DE CINEMÁTICA PARA O ENEM!! - Física Básica Completa", min: 80 },
      { t: "TUDO de HISTÓRIA DO BRASIL pro ENEM 2026 (teoria + questões)", min: 200 },
    ],
  },
];
