      ...
      <section id="planos" className="border-t border-border/40 py-20">
        <div className="mx-auto max-w-7xl px-4">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            {([
              { name: "ENEM Light", planType: "LIGHT" as PlanType, price: "19,90", oldPrice: null, periodo: "/mês", cta: "Começar Agora", popular: false, items: ["15 redações por mês","Linguagens, Códigos e suas Tecnologias","Ciências da Natureza e suas Tecnologias","1.000 questões e simulados","Plano de Estudo com IA","PDF metodologia de estudos","Cronograma de 30 dias","Templates de redação nota 1000","Acesso básico IA"] },
              { name: "ENEM Pro", planType: "PRO" as PlanType, price: "29,90", oldPrice: "39,90", periodo: "/mês", cta: "Quero o Pro", popular: true, items: ["30 redações por mês","Tudo do Light","Ciências Humanas e suas Tecnologias","Matemática e suas Tecnologias","As 4 áreas do ENEM liberadas","20 vídeo aulas","1.000 questões para passar","Simulados","Correção IA avançada","IA Professor Rígido","Plano de Estudo com IA","Repertórios automáticos","Cronograma inteligente"] },
              { name: "Full Acess ENEM", planType: "FULL" as PlanType, price: "49,90", oldPrice: null, periodo: "/mês", cta: "Quero Acesso Total", popular: false, items: ["60 redações por mês","Tudo do Pro","Redação completa","BÔNUS — 9 segredos para aprovação no vestibular","Correção IA ilimitada","1.000 questões avançadas","Vídeo aulas completas","Simulados ilimitados","Templates premium","Ranking de alunos","IA Professor Rígido","Plano de Estudo com IA","Repertórios automáticos","Estratégias de aprovação","Atualizações futuras"] },
              { name: "Full Acess ENEM Vitalício", planType: "VITALICIO" as PlanType, price: "499", oldPrice: null, periodo: "uma vez", cta: "Quero Vitalício", popular: false, items: ["Acesso ETERNO — sem mensalidade","70 redações por mês","Tudo do Full Acess","Redação completa","BÔNUS — 9 segredos para aprovação no vestibular","IA Professor Rígido vitalício","Plano de Estudo com IA vitalício","Atualizações futuras incluídas","Sem renovação, sem cobrança recorrente"] },
            ]).map((p) => (
